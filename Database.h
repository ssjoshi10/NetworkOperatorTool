...
///////////////fill structures////////////
	...
	void fill_validity_info(subscriber_info &,validity_info &);			fills the destination validity_info structure from source structure
	void fill_plan_info(subscriber_info &,plan_info &);						fills the destination plan_info structure from source structure
...
///////////////filling structures //////////
	...
	void fill_validity_info(subscriber_info &,validity_info &);
	void fill_plan_info(subscriber_info &,plan_info &);
////////////////////////////////////////////
public:
	map<ull , subscriber_info> *get_new_list_db(string );
	map<ull , subscriber_info> *get_gb_list_db(string );
	void display_list_db(string );
	...
	void read_file_db(ifstream &);
	void write_file_db(ofstream &);
